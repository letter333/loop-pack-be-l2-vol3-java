...
public class MonthlyProductRankEntity {
    ...
    public static MonthlyProductRankEntity from(ProductRankMv mv) {
        MonthlyProductRankEntity entity = new MonthlyProductRankEntity();
        entity.productId = mv.getProductId();
        entity.yearMonth = mv.getPeriodKey();

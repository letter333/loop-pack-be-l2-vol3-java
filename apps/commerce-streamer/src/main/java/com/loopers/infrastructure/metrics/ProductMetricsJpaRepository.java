...
public interface ProductMetricsJpaRepository extends JpaRepository<ProductMetricsEntity, ProductMetricsId> {
    ...
    @Modifying
    @Query(value = """
        INSERT INTO product_metrics (product_id, metric_date, like_count, view_count, sales_count, sales_amount, updated_at)
    ...
    List<ProductMetricsEntity> findByProductId(Long productId);
}
